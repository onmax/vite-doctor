...
test("Nuxt all-issues fixture reports Nuxt and ecosystem rule packs", async () => {
  ...
  expect(diagnosticKeys(result, nuxtFixture)).toEqual([
    ...
    "nuxt/context/no-composable-after-await:app/components/IssuePanel.vue",
    ...
    "nuxt/fetch/require-stable-asyncdata-key:app/components/IssuePanel.vue",
    "nuxt/fetch/require-stable-asyncdata-key:app/composables/useWrappedUser.ts",
    "nuxt/fetch/require-stable-asyncdata-key:app/pages/wrapper.vue",
    ...
    "nuxt/hydration/no-time-dependent-render-without-nuxttime-or-clientonly:app/components/IssuePanel.vue",
    ...
    "nuxt/middleware/no-route-middleware-api-security:app/aaa-security.ts",
    ...
    "vue/ssr/no-random-or-local-time-render:app/components/IssuePanel.vue",
